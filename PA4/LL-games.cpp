...
*/
GamesLinkedList::Node::Node(Games game)
{
	mData = game;
	mNext = NULL;
}
...
/*
	...
	Purpose: To reset all members to defaults
*/
GamesLinkedList::GamesLinkedList()
{
	mHead = NULL;
	mTail = NULL;
	mCount = 0;
...
*/
void GamesLinkedList::display()
{
	Node *tmp;

	if (mHead == NULL)
	{
		cout << "No games in shopping cart" << endl;
	}
	else
	{
		tmp = mHead;
...
/*
	Pre: Function called
	Post: Games linked list is printed to the specified file
	Purpose: To print out the contents of the games list
*/
void GamesLinkedList::printFile(string filename)
{
	ofstream fout;
...
*/
bool GamesLinkedList::insert(Games gameData)
{
	Node *newNode;
	newNode = new Node(gameData);
...
*/
bool GamesLinkedList::insertHead(Games gameData)
{
	Node *newNode;
...
*/
bool GamesLinkedList::isExist(string searchKey)
{
	bool found = false;
	Node *tmp;
	tmp = mHead;
...
*/
bool GamesLinkedList::remove(string searchKey)
{
	{
		...
		if (toBeDeleted != NULL)
		{
			...
			cout << "Deleting game with barcode " << searchKey << "..." << endl;
			cout << endl;
			delete toBeDeleted;
			mCount--;
			deleted = true;
...
*/
void GamesLinkedList::deleteList()
{
